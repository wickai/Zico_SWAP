    ...
    def search(self, inputs):
        ...
        for gen in range(self.n_generations):
            ...
            for i, indiv in enumerate(population):
                ...
                logging.info(
                    f"  [Ind-{i+1}] fitness(SWAP): {indiv['fitness']:.3f}")
...
def parse_args():
    ...
    parser.add_argument("--n_generations", default=1,
    ...
    # SWAP + param regular
    parser.add_argument("--use_param_regular", action="store_false",
    ...
    parser.add_argument("--train_batch", default=128,
                        type=int, help="batchsize for final training")
    parser.add_argument("--train_epochs", default=200,
                        type=int, help="epochs for final training")
    parser.add_argument("--lr", default=0.01, type=float,
                        help="initial lr for final training")
