...
params_dict = {
    'imagenet': {
        'train_dir': os.path.expanduser('/home/ubuntu/scratch/kaiwei/unzip_imagenet/ILSVRC/Data/CLS-LOC/train/'),
        'val_dir': os.path.expanduser('/home/ubuntu/scratch/kaiwei/unzip_imagenet/ILSVRC/Data/CLS-LOC/val_new/'),
